...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/twiliochat.css')); ?>">
  </head>
  <body>
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <div class="row"><div id="logo-column" class="col-md-2 col-md-offset-5">
            <img id="logo-image" src="<?php echo e(asset('img/twilio-logo.png')); ?>"/>
          </div></div>
      ...
      <div id="container" class="row">
        <div id="channel-panel" class="col-md-offset-2 col-md-2">
          ...
          <div class="row">
            <img id="add-channel-image" src="<?php echo e(asset('img/add-channel-image.png')); ?>"/>
          </div>
        </div>
        <div id="chat-window" class="col-md-4 with-shadow">
          ...
          <div id="connect-panel" class="disconnected row with-shadow">
            ...
            <div class="row">
              <div class="col-md-12">
                <img id="connect-image" src="<?php echo e(asset('img/connect-image.png')); ?>"/>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="<?php echo e(asset('js/vendor/jquery-throttle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/vendor/jquery.loadTemplate-1.4.4.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/twiliochat.js')); ?>"></script>
    <script src="<?php echo e(asset('js/dateformatter.js')); ?>"></script>
  </body>
</html>
